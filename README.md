...
The next noteboks contain the code used to perform this analysis. You can use [nbviewer](https://nbviewer.jupyter.org/) to render the notebooks if GitHub can't do it. Also you can open the notebook and replace the "github.com" domain by ["nbsanity.com"](https://nbsanity.com/) domain.
